...
#define	JEMALLOC_VERSION "3.1.0-0-g3b1f3aca54fede23299cde9034f7b909c3d290d7"
#define	JEMALLOC_VERSION_MAJOR 3
#define	JEMALLOC_VERSION_MINOR 1
#define	JEMALLOC_VERSION_BUGFIX 0
#define	JEMALLOC_VERSION_NREV 0
#define	JEMALLOC_VERSION_GID "3b1f3aca54fede23299cde9034f7b909c3d290d7"
...
JEMALLOC_EXPORT void	*je_malloc(size_t size) __THROW JEMALLOC_ATTR(malloc) ;
JEMALLOC_EXPORT void	*je_calloc(size_t num, size_t size) __THROW
    JEMALLOC_ATTR(malloc);
JEMALLOC_EXPORT int	je_posix_memalign(void **memptr, size_t alignment,
    size_t size) __THROW JEMALLOC_ATTR(nonnull(1));
JEMALLOC_EXPORT void	*je_aligned_alloc(size_t alignment, size_t size)
    JEMALLOC_ATTR(malloc);
JEMALLOC_EXPORT void	*je_realloc(void *ptr, size_t size) __THROW;
JEMALLOC_EXPORT void	je_free(void *ptr)__THROW;

#ifdef JEMALLOC_OVERRIDE_MEMALIGN
JEMALLOC_EXPORT void *	je_memalign(size_t alignment, size_t size) __THROW
    JEMALLOC_ATTR(malloc);
#endif

#ifdef JEMALLOC_OVERRIDE_VALLOC
JEMALLOC_EXPORT void *	je_valloc(size_t size) __THROW JEMALLOC_ATTR(malloc);
#endif

JEMALLOC_EXPORT size_t	je_malloc_usable_size(
    JEMALLOC_USABLE_SIZE_CONST void *ptr)__THROW;
